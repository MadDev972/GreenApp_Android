...
public class Combitech_competences extends Activity 
{
    ...
    public void onCreate(Bundle savedInstanceState) 
    {
        ...
        setContentView(R.layout.combitech_competences);
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
    	switch(item.getItemId())
    	{
    		...
    		case R.id.return_categories:
    			Intent intent = new Intent(Combitech_competences.this,DisplayCategories.class);
